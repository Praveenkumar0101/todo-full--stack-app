...
const db = mysql.createConnection({
  ...
  user: 'sql12738207', // Replace with your MySQL username
  password: 'LALKJZSsZ2', // Replace with your MySQL password
  database: 'sql12738207', // Replace with your MySQL database name
});

// const db = mysql.createConnection({
//   host: 'localhost',
//   user: 'root', // Replace with your MySQL username
//   password: 'Unstoppable@22', // Replace with your MySQL password
//   database: 'test-db', // Replace with your MySQL database name
// });
...
app.post('/tasks', upload.single('file'), (req, res) => {
  ...
  console.log( task_name, description, status, priority, deadline)
